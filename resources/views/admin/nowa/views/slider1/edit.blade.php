                ...
                <div class="mb-4">
                    ...
                    <div class="panel panel-primary tabs-style-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' class="form-control" id="short_description-{{$locale}}" name="{{$locale}}[short_description]'" value="{!! $slide->translate($locale)->short_description ?? '' !!}">
                            </input>
...
<div class="col-lg-6 col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            {{-- @dd($slide) --}}
            <img id="blah" src="{{isset($slide)&&$slide != null? $links . '/' . $slide->logo : '#'}}" alt="" style="{{$slide != null? 'width:auto; height:70px' : ''}}" />
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="number" name="position" value="{{$slide->position}}">
                @error('position')
                <small class="text-danger">
                    <div class="error">
                        {{$message}}
            ...
            <div class="form-group">
                <label class="ckbox">
                    <input type="checkbox" name="status" value="true" {{$slide->status ? 'checked' : ''}}>
