            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('admin.projects')</h4>
                    </div>
                    <a href="{{locale_route('raycontent.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.createbutt')</a>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('raycontent.edit',$item->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>

                                                <a href="{{locale_route('raycontent.destroy',$item->id)}}"
