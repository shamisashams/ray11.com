                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$locale.'[title]'}}" class="form-control" placeholder="@lang('admin.title')" value="{{$staff->translate($locale)->title ?? ''}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$locale.'[description]'}}" class="form-control" placeholder="@lang('admin.description')" value="{{$staff->translate($locale)->description ?? ''}}">
