            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('admin.team')</h4>
                    </div>
                    <a href="{{locale_route('teamb.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.createbutt')</a>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            @foreach(config('translatable.locales') as $locale)
                                                                <div class="tab-pane {{$loop->first?"active":""}}" id="cat-{{$locale}}-{{$item->id}}">
                                                                    {{$item->translate($locale)->name ?? ''}} {{$item->translate($locale)->surname ?? ''}}
                                                                </div>
                                                            @endforeach
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('teamb.edit',$item->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>

                                                <a href="{{locale_route('teamb.destroy',$item->id)}}"
