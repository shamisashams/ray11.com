        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <a href="{{locale_route('upcomingevents.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.create')</a>
                                    ...
                                    @foreach($sliders as $slider)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{locale_route('upcomingevents.edit',$slider->id)}}"
                                                   class="pl-3">
                                                    <i class="fa fa-edit">შეცვლა</i>
                                                </a>
                                                <a href="{{locale_route('upcomingevents.destroy',$slider->id)}}"
