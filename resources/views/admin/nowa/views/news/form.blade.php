...
@section('content')
    ...
    {{-- <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$news->created_at ? __('admin.partners-update') : __('admin.partners-create')}}</span>
        </div>
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        ...
                                        <div class="tab-pane {{$active}}" id="lang-{{$locale}}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$locale.'[title]'}}" class="form-control" placeholder="@lang('admin.title')" value="{{$news->translate($locale)->title ?? ''}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$locale.'[short_description]'}}" class="form-control" placeholder="@lang('admin.short_description')" value="{{$news->translate($locale)->short_description ?? ''}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{$locale.'[description]'}}" class="form-control" placeholder="@lang('admin.description')" value="{{$news->translate($locale)->description ?? ''}}">
