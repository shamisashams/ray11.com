...
const Form = () => {
    ...
    return (
        <div className="text-center form ">
            ...
            <form className="max-w-sm mx-auto" data-aos="fade-up">
                <input
                    type="text"
                ...
                <input
                    type="text"
                    placeholder={__("client.contact_form_address", sharedData)}
                />
                <textarea
                    placeholder={__("client.contact_form_messega", sharedData)}
                />
                <button
