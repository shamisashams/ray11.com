        ...
        <Layout seo={seo}>
                ...
                <div className="imageLayout wrapper flex items-center justify-center">
                    <div className="column w-1/5 lg:mx-2 mx-1">
                        <div
                            data-aos="flip-up"
                            data-aos-delay="500"
                            className="img medium overflow-hidden lg:my-4 my-2 border  border-solid sm:rounded-xl rounded-md border-custom-yellow"
                        >
                            <img
                    ...
                    <div className="column w-1/5 lg:mx-2 mx-1">
                        <div
                            data-aos="flip-left"
                            data-aos-delay="300"
                            className="img short overflow-hidden lg:my-4 my-2 border  border-solid sm:rounded-xl rounded-md border-custom-yellow"
                        >
                            <img
                                className="w-full h-full object-cover"
                                src={
                    ...
                    <div className="column w-1/5 lg:mx-2 mx-1">
                        <div
                            data-aos="zoom-in-up"
                            className="img long overflow-hidden lg:my-4 my-2 border  border-solid sm:rounded-xl rounded-md border-custom-yellow"
                        >
                            <img
                                className="w-full h-full object-cover"
                                src={
            ...
            <VideoPopup
                ...
                src={
                    page.url
                        ? page.url
                        : "https://www.youtube.com/embed/tl6T2nwRers"
                }
