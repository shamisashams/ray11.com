...
// use App\Http\Requests\Admin\ContentRequset;
use App\Http\Requests\Admin\ContentRequset;
...
// use App\Models\Content as Staff;
use App\Models\Content;
use App\Repositories\CategoryRepositoryInterface;
use App\Repositories\Eloquent\CustomerRepository;
// use App\Repositories\Eloquent\StaffRepository;
use App\Repositories\Eloquent\ContentRepository as StaffRepository;
...
class ContentController extends Controller
{
    ...
    public function index(ProductRequest $request)
    {
        ...
        return view('admin.nowa.views.content.index', [
    ...
    public function create()
    {
        ...
        $url = locale_route('raycontent.store', [], false);
        $method = 'POST';
        ...
        return view('admin.nowa.views.content.form', [
            'url' => $url,
            'method' => $method,
            'staff' => $staff,
     ...
     */
    public function store(ContentRequset $request)
    {
        ...
        return redirect(locale_route('raycontent.index', $customer->id))->with('success', __('admin.create_successfully'));
    }
     ...
     * @return Application|Factory|View
     */
    public function edit(string $locale, Content $content, $code)
    {
        $url = locale_route('raycontent.update', $code, false);
        $method = 'PUT';
        ...
        return view('admin.nowa.views.content.edit', [
            'staff' => $content->find($code),
            'url' => $url,
            'method' => $method,
            "category" => RayCompany::all(),
        ]);
     ...
     * @return Application|RedirectResponse|Redirector
     */
    public function destroy(string $locale, Content $staff, $code)
    {
        if (!$this->staffRepository->delete($code)) {
            return redirect(locale_route('raycontent.index', $code))->with('danger', __('admin.not_delete_message'));
        }
        return redirect(locale_route('raycontent.index'))->with('success', __('admin.delete_message'));
    }
